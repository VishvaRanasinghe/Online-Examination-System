		...
		<div class="navbar-inner">
			<div class="container">
				...
				<a href="#" class="brand"> <img src="./assets/img/logo.jpg"
					alt="Exam Show" width="60px" height="60px" /></a> <br />
...
<!-- 		<div class="row">
			...
			<div class="span2">
				<ul class="nav nav-tabs "
					...
					<li class="active"><a href="#" data-toggle="tab">Admin
							Home</a></li>
					<li><a href="#student" data-toggle="tab">Student Detail</a></li>
					<li><a href="#faculty" data-toggle="tab">Faculty Detail</a></li>
					<li><a href="#subject" data-toggle="tab">Subject Detail</a></li>
					<li><a href="#changepass" data-toggle="tab">Change
							Password</a></li>
				</ul>
			</div> -->
     ...
     <ul class="nav nav-pills mb-2" style='background-color: white; '>
					<li class="nav-link disabled"><a href="#" data-toggle="tab" >Admin
							Home</a></li>
					<li><a href="#student" data-toggle="tab">Student Detail</a></li>
					<li><a href="#faculty" data-toggle="tab">Faculty Detail</a></li>
					<li><a href="#subject" data-toggle="tab">Subject Detail</a></li>
...
active
     ...
     ">
						...
						<c:if test='${not empty param["studentSuccess"]}'>
							<p style="color: green; font-weight: bold;">Deletion is
								successful.</p>
						...
						<table class=" table table-bordered">
							...
							<tr>
								...
								<td colspan="1">Delete Student</td>
								<td><strong>Update Student</strong></td>
							</tr>
							<%
								while (rs.next()) {
							%>
...
%>
								...
								<td><i class="icon-remove"></i><a
									href="delete?user=<%out.print(rs.getString("studentid"));%>&who=student">Delete</a>
								</td>
								
								
								<td><i class="icon-remove"></i><a
									href="update?user=<%out.print(rs.getString("studentid"));%>&who=student">Update</a>
								</td>
     ...
     ">
						...
						<table class=" table table-bordered">
							...
							<tr>
								...
								<td colspan="1">Delete Faculty</td>
								<td><strong>Update Student</strong></td>
							</tr>
							<%
								while (rs.next()) {
...
%>
								...
								<td><i class="icon-remove"></i><a
									href="delete?user=<%out.print(rs.getString("facultyid"));%>&who=faculty">Delete</a>
								</td>
								
								<td><i class="icon-remove"></i><a
									href="update?user=<%out.print(rs.getString("facultyid"));%>&who=faculty">Update</a>
								</td>
							</tr>
...
">
						...
						<table class=" table table-bordered">
							...
							<tr>
								...
								<td colspan="1">Delete Subject</td>
								<td colspan="1">Update Subject</td>
							</tr>
							<%
								while (rs.next()) {
							%>
...
%>
								...
								<td><i class="icon-remove"></i><a
									href="delete?user=<%out.print(rs.getString("subjectcode"));%>&who=subject">Delete</a>
								</td>
								
								<td><i class="icon-remove"></i><a
									href="delete?user=<%out.print(rs.getString("subjectcode"));%>&who=subject">Update</a>
								</td>
...
<c:if test='${not empty param["Success"]}'>
 ...
 ">
						<form action='<%=response.encodeURL("adminpasschange")%>'
