...
<body style="background-color: #279EFF;">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container">
				...
				<h1 class="brand" style="font-weight: bold;">Online Examination
					System</h1>
			</div>
		</div>
	...
	<div class="container well">
		<div class="row">
			<div class="span6">
				<p style="font-weight: bold; font-size: 15px; color: #808080;">AdminPanel</p>
			</div>
			...
			<div class="span6">
				...
				<form action='<%=response.encodeURL("adminlogin")%>'
					...
					<div class="control-group">
						<label class="control-label" for="name">AdminID</label>
						<div class="controls">
