...
<a href="home.jsp" class="brand"> <img src="./assets/img/logo.jpg" alt="Exam Show" width="60px" height="60px"/></a>
<br/>
...
<p class="pull-right" style="color:black; padding-bottom:10px">
<br />
<%
...
<div class="container well">
 ...
 // out.println("bc");
                            ...
                            //session.setAttribute("subname",sname);
                             String qry = "SELECT COUNT(*) as col FROM information_schema.tables WHERE table_schema = 'online_exam' AND table_name = '"+scode+"'";
              ...
              <div class="span2 pull-right">
                      <script type="application/javascript">
                            ...
                            <%
                             ...
                             {
                                out.println("<center><p style='font-weight:bold;color:red;'> Exam has not been started.</p></center><br/><br/>");
...
%>
        ...
        <%
                               ...
                               out.println("<center><p style='font-weight:bold;color:red;'> Exam has been ended.</p></center><br/><br/>");
...
{
 //not registered
    out.println("<p style='font-weight:bold;color:red;'> You are not Registered for this Exam.</p><a href='upcomingevents.jsp'>click here to Register</a>");
