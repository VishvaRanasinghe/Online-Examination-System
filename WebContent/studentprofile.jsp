...
<body style="background-image: url(assets/img/background.jpg); background-size: cover; background-repeat: no-repeat;">
	...
	<div class="container well" style="height: 650px; text-align: center;">
     ...
     <ul class="nav nav-pills mb-2" style='background-color: white; '>
					<li><a href="./home.jsp">Home</a></li>
					<li><a href="#profile" data-toggle="tab">Profile</a></li>
					<li><a href="#viewsub" data-toggle="tab">View Subjects</a></li>
					<li><a href="#viewresult" data-toggle="tab">View Results</a></li>
					<li><a href="#exam" data-toggle="tab">Exam</a></li>
					<li><a href="#notice" data-toggle="tab">Notification</a></li>
					<li><a href="#ChangPassword" data-toggle="tab">Change
...
The effective use of "Online Examination System", any Educational Institute or training centers can be use it to develop their strategy for putting the exams, and for getting better results in less time.
					...
					<div id="profile" class="tab-pane" style="text-align: center;">
						...
						<h1 style='color: #3399FF; '>User Profile</h1><br></br>
						<%
							Connection con = null;
						Statement st = null;
						ResultSet rs = null;
					...
					<h1 style='color: #3399FF; '>View Subjects</h1><br></br>
						...
						%>
						<table id="sortTableExample" class='table zebra-striped' style="padding-left: 20%">
							<thead>
								<tr>
...
active
									...
									<form action="result.jsp" id="contact-form"
										class="form-horizontal" method="post" style="padding-left: 20%">

										<div class="control-group">
											<label class="control-label" for="password">Subject
												Code</label>
											<div class="controls">
												...
												<c:if test='${not empty param["Unavailable"]}'>
													<p style='font-weight: bold; color: green'>Result will
														be available soon.</p>
												</c:if>
												...
												<c:if test='${not empty param["ErrorCode"]}'>
													<p style='font-weight: bold; color: red'>Wrong Subject
														Code</p>
												</c:if>
...
active
                     ...
                     <h1 style='color: #3399FF; '>Ongoing Exams</h1><br></br>
                     

									<form action="showpaper_servlet" id="contact-form"
										class="form-horizontal" method="post" style="padding-left: 20%">
								...
								<div id="notice" class="tab-pane fade in" style="padding-left: 20%">
...
<c:if test='${not empty param["Success"]}'>
 ...
 <h1 style='color: #3399FF; '>Change Password</h1><br></br>
 
 
									<form action='<%=response.encodeURL("studentpasschange")%>'
										id="contact-form4" class="form-horizontal" method="post" style="padding-left: 20%">
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-prepend">
													 <input
														type="password" class="input-large" name="passwd"
														id="passwd" placeholder="Current Password" required="true"
														onkeyup="loadXMLDoc()" /> <span id="err"> </span>
												</div>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="apasswd">New
												Password</label>
											<div class="controls">
												<div class="input-prepend">
													 <input
										...
										<div class="control-group">
											<label class="control-label" for="conpasswd">Re
												Password</label>
											<div class="controls">
												<div class="input-prepend">
													 <input
														type="password" class="input-large" name="conpasswd"
														id="conpassword" required="true"
										...
										<div class="control-group">
											...
											<div class="controls">
												<c:if test='${not empty param["Success"]}'>
													<p style="color: green; font-weight: bold;">Your
