...
--
-- Dumping data for table `qw`
--

LOCK TABLES `qw` WRITE;
/*!40000 ALTER TABLE `qw` DISABLE KEYS */;
INSERT INTO `qw` VALUES (1,'<p>hgfhfkhgk</p>','1','2','3','4','1');
/*!40000 ALTER TABLE `qw` ENABLE KEYS */;
UNLOCK TABLES;
